        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-7">
                    ...
                    <ul className="list-group rounded">{/* transaksi */}
                        <li className="list-group-item list-group-item-danger mb-3">
                                <div className="row">
                                <div className="col-9">
                                    <ul className="list-group"> {/*produk dalam transaksi*/}
                                        ...
                                        <li className="list-group-item list-group-item-danger">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="ml-3 text-red">
                                                    ...
                                                    <p><span className="text-brown">Topping : </span>Bill Berry Boba, Bill Berry Gelatin</p>
                                                    <p><span className="text-brown">Price : </span><strong>Rp. 33.000</strong></p>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
